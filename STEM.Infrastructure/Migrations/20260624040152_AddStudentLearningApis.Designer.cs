...
namespace STEM.Infrastructure.Migrations
{
    ...
    [Migration("20260624040152_AddStudentLearningApis")]
    partial class AddStudentLearningApis
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("STEM.Core.Entities.Quizzes.QuizAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("STEM.Core.Entities.Quizzes.QuizAttemptAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("STEM.Core.Entities.Quizzes.QuizAttemptAnswer", b =>
                {
                    b.HasOne("STEM.Core.Entities.Quizzes.QuizAnswer", "Answer")
                        .WithMany()
                    ...
                    b.HasOne("STEM.Core.Entities.Quizzes.QuizAttempt", "QuizAttempt")
                        .WithMany("Answers")
